...
print("Command Base Results")
results = evaluate_summaries_from_csv("Results_Base/Command/prediction_summaries.csv")
print(results)

print("Command Lora Results")
results = evaluate_summaries_from_csv("Results_Lora/Command/prediction_summaries2.csv")
print(results)

print("Command LoraFA Results")
results = evaluate_summaries_from_csv("Results_LoraFA/Command/prediction_summaries.csv")
print(results)

print("Command AdaLora Results")
results = evaluate_summaries_from_csv("Results_AdaLora/Command/prediction_summaries2.csv")
print(results)
