...
print("Base Mistral")
generator_mistral_base = pipeline("text-generation", model="mistralai/Mistral-7B-Instruct-v0.3")
process_all_documents(test_docs, generator_mistral_base, "Results_Base/Mistral/prediction_summaries.csv")

print("Lora Mistral")
generator_mistral_lora = pipeline("text-generation", model="Results_Lora/Mistral/my_trained__mistral_model")
process_all_documents(test_docs, generator_mistral_lora, "Results_Lora/Mistral/prediction_summaries.csv")

print("LoraFA Mistral")
generator_mistral_lora_fa = pipeline("text-generation", model="Results_LoraFA/Mistral/my_trained__mistral_model")
process_all_documents(test_docs, generator_mistral_lora_fa, "Results_LoraFA/Mistral/prediction_summaries.csv")

print("AdaLora Mistral")
generator_mistral_ada_lora = pipeline("text-generation", model="Results_AdaLora/Mistral/my_trained_model")
process_all_documents(test_docs, generator_mistral_ada_lora, "Results_AdaLora/Mistral/prediction_summaries.csv")