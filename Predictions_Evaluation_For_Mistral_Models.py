...
def evaluate_summaries_from_csv(pred_csv_path, ref_csv_path, summary_column="summary"):
    """
...
print("Mistral Base Results")
results = evaluate_summaries_from_csv("Results_Base/Mistral/prediction_summaries.csv")
print(results)

print("Mistral Lora Results")
results = evaluate_summaries_from_csv("Results_Lora/Mistral/prediction_summaries2.csv")
print(results)

print("Mistral LoraFA Results")
results = evaluate_summaries_from_csv("Results_LoraFA/Mistral/prediction_summaries2.csv")
print(results)

print("Mistral AdaLora Results")
results = evaluate_summaries_from_csv("Results_AdaLora/Mistral/prediction_summaries2.csv")
print(results)
