...
print("Base Qwen")
generator_Qwen_base = pipeline("text-generation", model="Qwen/Qwen2.5-7B-Instruct")
process_all_documents(test_docs, generator_Qwen_base, "Results_Base/Qwen/prediction_summaries.csv")

print("Lora Qwen")
generator_Qwen_lora = pipeline("text-generation", model="Results_Lora/Qwen/my_trained_qwen_model")
process_all_documents(test_docs, generator_Qwen_lora, "Results_Lora/Qwen/prediction_summaries2.csv")

print("LoraFA Qwen")
generator_Qwen_lora_fa = pipeline("text-generation", model="Results_LoraFA/Qwen/my_trained__qwen_model")
process_all_documents(test_docs, generator_Qwen_lora_fa, "Results_LoraFA/Qwen/prediction_summaries2.csv")

print("AdaLora Qwen")
generator_Qwen_ada_lora = pipeline("text-generation", model="Results_AdaLora/Qwen/my_trained_qwen_model")
process_all_documents(test_docs, generator_Qwen_ada_lora, "Results_AdaLora/Qwen/prediction_summaries2.csv")
